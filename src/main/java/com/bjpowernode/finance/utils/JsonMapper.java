 ...
 */
package com.bjpowernode.finance.utils;
...
public class JsonMapper extends ObjectMapper {
    ...
    /**
     * 当前类的实例持有者（静态内部类实现，懒汉式，线程安全的单例模式）
     */
    private static final class JsonMapperHolder {
        private static final JsonMapper INSTANCE = new JsonMapper(Include.NON_NULL).enableSimple();
        private static final JsonMapper NON_DEFAULT_MAPPER = new JsonMapper(Include.NON_DEFAULT).enableSimple();
    }
...
//		}
    ...
    public static JsonMapper nonDefaultMapper() {
        return JsonMapperHolder.NON_DEFAULT_MAPPER;
    }
